...
import com.example.event.Adapter.NotificationAdapter
import com.example.event.R
import com.example.event.databinding.FragmentNotifactionBottomBinding
...
class NotificationBottomFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val notifications = listOf(
            "Your items has been Canceled Successfully",
            "Items has been taken by the driver",
